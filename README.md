...
<h1 align=left> AirBnB Clone </h1>

## Descriptions :house:

AirBnB is a complete web application, integrating database storage/file storage engine 'JSON', a back-end API, and front-end interfacing in a clone of AirBnB.
